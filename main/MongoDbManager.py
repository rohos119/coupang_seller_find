...
class MongoDbManager :
    ...
    def update_seller(cls,_query,new_values):
        assert cls.database
        return cls.database.seller_db.update(_query,new_values)

    def create_new_seller(cls,_query):
        assert cls.database
        return cls.database.seller_db.save(_query)
    ...
    def remove_mancat_collection(cls,_query):
        assert cls.database
        return cls.database.get_collection('man_cat').delete_many(_query)

    def get_all_womancat_collection(cls,_query):
        assert cls.database
        return cls.database.get_collection('woman_cat').find(_query)

    def remove_womancat_collection(cls,_query):
        assert cls.database
        return cls.database.get_collection('woman_cat').delete_many(_query)
